...
class Fsubjectspage extends StatefulWidget {
  const Fsubjectspage({Key? key}) : super(key: key);

  @override
  _FsubjectspageState createState() => _FsubjectspageState();
}

class _FsubjectspageState extends State<Fsubjectspage>
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return Padding(
                                          ...
                                          child: FsubjectCard(
                                              subject: fsub[index].subject,
                                              lecDate: fsub[index].lecDate,
                                              lecTime: fsub[index].lecTime,
                                              Stream: fsub[index].stream,
                                              Div: fsub[index].div,
                                              Year: fsub[index].year),
                                        );
                                      }),
                                ),
                              ]),
