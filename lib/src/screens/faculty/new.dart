...
class ftbPage extends StatefulWidget {
  final String title;
  const ftbPage({Key? key, required this.title}) : super(key: key);

  @override
  _ftbPageState createState() => _ftbPageState();
}

class _ftbPageState extends State<ftbPage> {
  double width = 0.0;
  double height = 0.0;
